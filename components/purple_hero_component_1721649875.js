...
Vue.component("purple_hero_component_1721649875", {
    template: `
            ...
            <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
                ...
                <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                            ...
                            <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-slate-300 hover:text-white before:bg-slate-800/50" 
                               ...
                               style="background: linear-gradient(theme(colors.purple.500), theme(colors.purple.500)) padding-box, linear-gradient(theme(colors.purple.500), theme(colors.purple.200) 75%, theme(colors.transparent) 100%) border-box;">
                                <span id="announcement-link-text" class="relative inline-flex items-center">
                                    New! Analyze Ethereum transactions in real-time. 
                    ...
                    <div class="flex" id="hero-text-container">
                        <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Gain Valuable Insights on Ethereum</h1>
                    </div>
                    <div class="flex" id="sub-hero-text-container">
                        <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Our powerful analytics engine dissects new Ethereum transactions, providing rich data for developers, researchers, and enthusiasts.</p>
                    </div>
                    <div id="hero-buttons" class="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4" data-aos="fade-down" data-aos-delay="400">
                        <div id="get-started-button-container" class="flex">
                            <a id="get-started-button" class="flex-1 btn w-full transition duration-150 ease-in-out group text-slate-900 bg-gradient-to-r from-white/80 via-white to-white/80 hover:bg-white" href="#0">
                                Get Started 
                        ...
                        <div id="docs-button-container" class="flex">
                            <a id="docs-button" class="flex-1 btn bg-opacity-25 hover:bg-opacity-30 w-full transition duration-150 ease-in-out text-slate-200 hover:text-white bg-slate-900" href="#0">
